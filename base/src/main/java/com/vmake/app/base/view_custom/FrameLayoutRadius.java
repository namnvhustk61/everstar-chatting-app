...
public class FrameLayoutRadius extends FrameLayout {
    ...
    public FrameLayoutRadius(Context context) {
        super(context);
        init(context, null);
    }

    public FrameLayoutRadius(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FrameLayoutRadius(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public FrameLayoutRadius(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {

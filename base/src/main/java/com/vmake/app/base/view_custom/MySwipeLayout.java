...
public class MySwipeLayout extends FrameLayout {
    ...
    public interface SwipeListener {
        public void onStartOpen(MySwipeLayout layout);

        public void onOpen(MySwipeLayout layout);

        public void onStartClose(MySwipeLayout layout);

        public void onClose(MySwipeLayout layout);

        public void onUpdate(MySwipeLayout layout, int leftOffset, int topOffset);

        public void onHandRelease(MySwipeLayout layout, float xvel, float yvel);
    }
    ...
    public static interface SwipeDenier {
         ...
         * gestures As a child of MySwipeLayout
         *
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                l.onHandRelease(MySwipeLayout.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(MySwipeLayout.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(MySwipeLayout.this);
                }
                mEventCounter = 0;
            }
    ...
    public interface OnLayout {
        public void onLayout(MySwipeLayout v);
    }
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!beforeCheck && mIsBeingDragged) {
                    ...
                    //useful when MySwipeLayout wrap a MySwipeLayout or other gestural layout
                    return false;
                }
                break;
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(MySwipeLayout.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, MySwipeLayout.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, MySwipeLayout.this, p, vId);
                }
                if (handled) {
...
//        super.setOnClickListener(l);
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(MySwipeLayout.this, target == surface);
            }
            return true;
        }
    }
    ...
    public interface DoubleClickListener {
        public void onDoubleClick(MySwipeLayout layout, boolean surface);
    }
